...
# FOR HIP EXO:
register_env_with_variants(id='myoTSA-v0',
    entry_point='myosuite.envs.myo.myobase.base_TSA:BaseTSAV0',
    max_episode_steps=100,
    kwargs={
...
register_env_with_variants(id='TorsoLegs',
    entry_point='myosuite.envs.myo.myobase.base_torso:BaseTorso',
    max_episode_steps=100,
    kwargs={
